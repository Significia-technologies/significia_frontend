...
This section is for recording discussion points between the advisor and client regarding the risk profile assessment results.

Key discussion points to consider:
• Review of risk profile classification and client's agreement/disagreement
• Discussion of investment objectives and time horizon
• Consideration of any life changes that may impact risk tolerance
• Review of portfolio volatility expectations
...
export const Q2_FACTORS = [
  ...
  { code: "b", desc: "Long-term appreciation" },
  { code: "c", desc: "Takeover potential" },
  { code: "d", desc: "6-month price trend" },
  { code: "e", desc: "5-year price trend" },
  { code: "f", desc: "Peer recommendation" },
